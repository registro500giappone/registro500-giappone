/* 旅ページ第8号「ルームランプが点かない」の絵。journey_id: room_lamp_dark（URLと対＝変えない）
   ...
   ⚠️系統8 を新設した旅＝NET_VERSION 6→7（部品 room_lamp・room_sw・door_sw、電線 w08-01〜05）。 */
(function () {
  'use strict';
  ...
  function draw(k, mode) {
    ...
    /* ヒューズの先で2手に分かれる＝もう1本はホーンへ（第7号の旅） */
    k.node(X, FZ + 62);
