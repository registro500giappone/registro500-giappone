/* ストーリー第5回「あちこち同時に点かない（アース）」の絵。図の点灯・色・黄点はすべて wiring-sim.js（L1到達性）の solve() 結果＝絵に合わせて数字を作らない。
   ...
   データ追加ゼロ＝既存のアース5か所（w11-08/09/10/11・w07-02）だけで全場面が解けている。 */
(function () {
  'use strict';
  ...
  /* 車体にぶら下がる4本のアース。ここに並ぶ順＝絵の上から下の順。「何の帰り道か」は原典の結線から導いたもので、絵の都合で書いていない：ダイナモの−がチャージランプの帰り道になるのは、停止中のダイナモ内部で 51↔−がつながっているから（wiring-net.json の dynamo モデル・第1回の主題そのもの）。
