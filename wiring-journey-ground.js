/* ストーリー第5回「あちこち同時に点かない（アース）」の絵。journey_id: ground_return（URLと対＝変えない）
   ...
   このストーリーだけの特徴＝【絵の向きが裏返っている】。
     第1〜4回 … ＋の道（行き）を上から下へたどる。アースは絵の一番下の記号。
     第5回   … その【帰り道】だけを描く。＋の道は破線1本に畳んで「第1〜4回でたどった」と手放す。
...
(function () {
  ...
  /* 車体にぶら下がる4本のアース線。ここに並ぶ順＝絵の上から下の順。
     ⚠️「何の帰り道か」は原典の結線から導いたもので、絵の都合で書いていない：
        ...
        つながっているから（wiring-net.json の dynamo モデル・第1回の主題そのもの）。
  ...
  function draw(k, mode) {
    ...
    /* 縦の線を1本外して描く（第3・4回と同じ作法）。⚠️接点ではなく「線が無い」状態 */
    ...
    /* 板の名前は【板の右外】に縦書きで置く＝板の中に置くと黄点の列と重なる（第3回の教訓と同じ、
