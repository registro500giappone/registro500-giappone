...
<style>
  :root {{ --bg-main:#f5f0e6; --card-bg:#fffefb; --accent:#1f5c3d; --text-main:#2e2a24; --sub:#7a705f; --line:#d6c9b0; --nav:#1A1A18; }}
  @media (prefers-color-scheme: dark) {{
    :root {{ --bg-main:#1a1714; --card-bg:#2b2721; --accent:#7fb894; --text-main:#ece6d9; --sub:#a89e8c; --line:#403a30; }}
  }}
  * {{ box-sizing:border-box; }}
  ...
  .b500 {{ background:#e7efe7; color:#1f5c3d; }}
  ...
  @media (prefers-color-scheme: dark) {{ .btn-map, .btn-share {{ background:#1a1714; }} }}
  ...
  @media (prefers-color-scheme: dark) {{ .name {{ background:#1a1714; }} }}
  ...
  @media (prefers-color-scheme: dark) {{ .btn-join.joined {{ background:#1a1714; }} }}
...
<style>
  :root {{ --bg:#f5f0e6; --card:#fffefb; --accent:#1f5c3d; --ink:#2e2a24; --sub:#7a705f; --line:#d6c9b0; }}
  @media (prefers-color-scheme: dark) {{
    :root {{ --bg:#1a1714; --card:#2b2721; --accent:#7fb894; --ink:#ece6d9; --sub:#a89e8c; --line:#403a30; }}
  }}
